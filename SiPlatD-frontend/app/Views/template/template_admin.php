...
<php lang="en">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                ...
                                <a href="<?php echo base_url('home/logout') ?>" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('home/manufacture') ?>">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/warehouse_product') ?>">Product</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/warehouse_material') ?>">Material</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="form-elements">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/report_product') ?>">Product</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/report_material') ?>">Material</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/master_product') ?>">Product</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/master_material') ?>">Material</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <script>
            $(document).on("click", ".open-editSelectedID", function () {
                // var editId = $(this).data('id');
                // $(".modal-body #selectedID").val( editId );
                $(".modal-body #selectedID").val($(this).data('id'));
                $(".modal-body #type").val($(this).data('type'));
                $(".modal-body #quantity").val($(this).data('quantity'));
                $(".modal-body #product_id").val($(this).data('product_id'));
                $(".modal-body #material_id").val($(this).data('material_id'));
        ...
        <script>
            $(document).on("click", ".open-editProduct", function () {
                ...
                $(".modal-body #material").val($(this).data('material_id'));
                $(".modal-body #stock_quantity").val($(this).data('stock_quantity'));
